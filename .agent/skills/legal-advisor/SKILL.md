---
name: legal-advisor
description: A team of AI agents for legal advice, contract analysis, and regulatory compliance.
---

# AI Legal Agent Team

**A team of AI agents for legal advice, contract analysis, and regulatory compliance.**

This skill leverages an advanced Python-based AI Agent or Multi-Agent Team located in the `scripts/` directory.

## Instructions
1. Use this skill whenever the user triggers the associated playbook or asks for legal-advisor.
