...
│     (CRITICAL/, BUGS/, PEOPLE/, PROJECTS/, STRATEGY/, etc.)    │
└─────────────────────────────────────────────────────────────────┘
```
...
| `#task [text]`    | PROJECTS/                   | Requirements Translator  |
| `#feature [text]` | FEEDBACK/feature-requests/  | Requirements Translator  |
| `#ux [text]`      | PEOPLE/ux-tasks.md          | UX Collaborator          |
| `#eng [text]`     | PEOPLE/engineering-items.md | Engineering Collaborator |
| `#note [text]`    | \_INBOX/notes/              | Requirements Translator  |
...
├── _QUEUE/                ← Items needing user input
├── CRITICAL/              ← Boss requests, escalations
├── BUGS/                  ← Bug tracking
├── FEEDBACK/              ← Feature requests
├── PEOPLE/                ← Stakeholders, team tasks
