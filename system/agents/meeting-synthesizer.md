...
│  2. DETECT PRODUCT CONTEXT (Scan vault/products/*.md)                 │
...
- **Context Scan**: Look for keywords matching `vault/products/[context].md`
...
| Type | Location |
|------|----------|
| 1:1 Notes | `vault/meetings/1-on-1s/[YYYY-MM-DD]-[person].md` |
| Standup Notes | `vault/meetings/standups/[YYYY-MM-DD]-standup.md` |
| Stakeholder Reviews | `vault/meetings/stakeholder-reviews/[YYYY-MM-DD]-[subject].md` |
| Customer Calls | `vault/meetings/customer-calls/[YYYY-MM-DD]-[company].md` |
| General Meetings | `vault/meetings/general/[YYYY-MM-DD]-[subject].md` |
...
*Connected to the Beats PM Brain Mesh v1.5.2*
```
