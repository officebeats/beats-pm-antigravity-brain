...
2. **Boss Requests Status** - From tracking/critical/boss-requests.md
...
5. **Engineering Collaboration** - From tracking/people/engineering-items.md
6. **UX Collaboration** - From tracking/people/ux-tasks.md
...
├── tracking/critical/boss-requests.md     → Boss request status
├── tracking/bugs/bugs-master.md           → Bug metrics
├── tracking/people/engineering-items.md   → Eng collaboration
├── tracking/people/ux-tasks.md            → UX collaboration
├── tracking/people/stakeholders.md        → Stakeholder updates
├── tracking/projects/projects-master.md   → Project status
├── tracking/strategy/                     → Strategy pulse
├── vault/meetings/daily-briefs/        → Daily progress
...
| Report  | Location                                         |
| ------- | ------------------------------------------------ |
| Weekly  | `vault/meetings/weekly-digests/[YYYY-MM-DD]-weekly.md` |
| Monthly | `vault/meetings/monthly-digests/[YYYY-MM]-monthly.md`  |
